...
// Interface A GPIO (sequential ports for parallel PCB routing)
...
#define IFACE_OUT4_PIN  31  // P3.1 -> chip pin 7  -> Ribbon pin 14
#define IFACE_OUT5_PIN  30  // P3.0 -> chip pin 8  -> Ribbon pin 16
#define IFACE_IN6_PIN   11  // P1.1 -> chip pin 9  -> Ribbon pin 18
#define IFACE_IN7_PIN   10  // P1.0 -> chip pin 10 -> Ribbon pin 20

// IR LED — P3.4 has PWM2 default routing (NOT PWM1)
#define IR_LED_PIN        34  // P3.4 -> chip pin 16 (PWM2 default)

// Activity LED
#define ACT_LED_PIN       32  // P3.2 -> chip pin 1

// USB is on P3.6 (D+) and P3.7 (D-) — dedicated, not configurable
